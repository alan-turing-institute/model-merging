...
NAMES=(base jan-nano abliterated pythagoras-prover qvikhr-instruction chinese-error-corrector met-d osim merged-linear merged-ties merged-dare-ties merged-task-arithmetic)
PATHS=("$@")
