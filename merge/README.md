...
```bash
uv run mergekit-yaml merge_task_arithmetic_config.yaml ../models/merged_task_arithmetic --cuda --lazy-unpickle --allow-crimes --lora-merge-cache ../models/.lora_merge_cache
uv run mergekit-yaml merge_ties_config.yaml            ../models/merged_ties            --cuda --lazy-unpickle --allow-crimes --lora-merge-cache ../models/.lora_merge_cache
uv run mergekit-yaml merge_dare_ties_config.yaml       ../models/merged_dare_ties        --cuda --lazy-unpickle --allow-crimes --lora-merge-cache ../models/.lora_merge_cache
uv run mergekit-yaml merge_model_stock_config.yaml     ../models/merged_model_stock      --cuda --lazy-unpickle --allow-crimes --lora-merge-cache ../models/.lora_merge_cache
uv run mergekit-yaml merge_slerp_config.yaml           ../models/merged_slerp            --cuda --lazy-unpickle --allow-crimes --lora-merge-cache ../models/.lora_merge_cache
uv run mergekit-yaml merge_arcee_fusion_config.yaml    ../models/merged_arcee_fusion     --cuda --lazy-unpickle --allow-crimes --lora-merge-cache ../models/.lora_merge_cache
```
