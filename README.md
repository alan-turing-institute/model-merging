...
| Self-distillation onto a merge | crime halves, teacher logprobs | recovery fraction *R* vs. the merge it repairs | [KD.md](KD.md), [run_kd_pipeline.sh](run_kd_pipeline.sh) |
